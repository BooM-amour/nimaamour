...
local function run(msg, matches)
  if matches[1]:lower() == 'x' then -- Put everything you like :)
  ...
  if matches[1]:lower() == "stats" then
    ...
    if matches[2] == "x" then -- Put everything you like :)
...
return {
  patterns = {
    ...
    "^[!/]([Ss]tatslist)$",
    "^[!/]([Ss]tats) (group) (%d+)",
    "^[!/]([Ss]tats) (x)",-- Put everything you like :)
		"^[!/]([Xx])"-- Put everything you like :)
    }, 
  run = run
}
